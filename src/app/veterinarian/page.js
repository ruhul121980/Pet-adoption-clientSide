...
export default  function  veterinarian () {
    ...
    const handleChange = (e)=>{
      ...
      if(name == 'search'){
          setSearch(value)
          const matchingProducts = handleSearch(value, vetPosts);
    ...
    <main  className="min-h-screen w-full flex flex-col items-center">
      <h2 className='font-semibold  text-center p-5 text-3xl md:text-4xl lg:text-5xl'>Find veterinarian Services</h2>
      <div>
      ...
      <div className='w-full lg:w-[80%] p-5 flex flex-col lg:flex-row  gap-3 ' >
          {
              ...
              className='w-[300px] '>
                <div className='  rounded-lg overflow-hidden text-xs shadow-md hover:shadow-lg duration-100'>
                  <div className='relative z-[-100] '>
                    <img className='w-full min-h-[340px] bg-gray-100 z-0' src={i.images.length? i.images[0] : i.img} alt={i.serviceTitle} />
                  ...
                  <div className='p-2'>
                    <div className='flex justify-between items-center'>
                      ...
                      <div className='flex  items-center gap-2'>
                        ...
                        <span className=' font-bold text-lg capitalize'>{i.fee}</span>
                      </div >
                    </div>
      ...
      <div className='w-full lg:w-[80%] p-5 flex flex-col lg:flex-row  gap-3 ' >
          {
            vetPosts && Search.length < 1 && notfound.length <1 &&
