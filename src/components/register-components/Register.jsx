...
const Register = () => {
  ...
  return (
    <div className="w-full lg:w-[85%]   grid grid-cols-1 lg:grid-cols-2 p-5 ">
        ...
        <div  >
            ...
            <form onSubmit={handleSubmit} className="w-full lg:w-2/3 p-5 flex flex-col gap-1"> 
                <div className="grid grid-cols-2 gap-1 border bg-custom-violet-light/10 p-1 rounded">
                     ...
                     className={`p-2  rounded ${registerType == 'user'? ' bg-custom-violet-light/50':'hover:bg-custom-violet-light/40'}`}>User</button>
                     <button 
                     onClick={()=>setRegisterType('veterinarian')} 
                     className={`p-2 rounded ${registerType == 'veterinarian'? ' bg-custom-violet-light/50':'hover:bg-custom-violet-light/40'}`}>Veterinarian</button>
                </div>
