...
function VeterinarianSection() {
  ...
  let homeVetPosts = vetPosts?.slice(0,4)
  // console.log(vetPosts)
  return (
    <div className=' flex flex-col items-center  justify-center'>
      <div className='w-full md:w-[85%] flex flex-col items-center md:items-start text-center md:text-start  justify-center gap-5 p-5' >
        ...
        <div>
          <Link href={'/veterinarian'} className='text-custom-violet hover:text-custom-violet/90 underline  '>View all Veterinarians
          </Link>
        </div>
      </div>
