  ...
  return (
    <div className='flex flex-col items-center justify-center py-10 p-5'>
        ...
        <footer className='text-xs flex items-center justify-center text-center  p-3'>
          ...
          <Link href={'/admin'} className=' ml-2 px-3 py-2 font-semibold rounded-full bg-purple-500/80 text-white/80 hover:bg-purple-700 hover:text-white ease-in duration-200'>Admin Panel</Link>
        </footer>
    </div>
  );
}
